...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2022 at 07:33 PM
...
CREATE TABLE `staffs` (
  ...
  `PRESENT ADDRESS` varchar(55) NOT NULL,
  `PERMANENT ADDRESS` varchar(55) NOT NULL
...
CREATE TABLE `students` (
  ...
  `STUDENTPERMANANTADDRESS` varchar(55) NOT NULL,
...
INSERT INTO `students` (`USERID`, `STUDENTNAME`, `STUDENTFATHERNAME`, `STUDENTMOTHERNAME`, `STUDENTEMAIL`, `STUDENTPHONE`, `STUDENTFATHERPHONE`, `STUDENTPERMANANTADDRESS`, `STUDENTPRESENTADDRESS`, `STUDENTGENDER`, `STUDENTNID`, `STUDENTCOURSE`, `STUDENTSSC`, `STUDENTHSC`) VALUES
(1, 'NAME A', 'NAME B', 'NAME C', 'NAME@NAME.COM', '123456789', '123045678', 'ADRRESS PERMANENT', 'ADDRESS PRESENT', 'MALE', '120123456789', 'Item 3', '4.50', '5.00');
